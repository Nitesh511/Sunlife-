...
const Depository_part = () => {
  return (
    <div>
      <div className="relative h-96 bg-gray-300 overflow-hidden">
        ...
        <div className="relative h-full flex flex-col justify-between p-32 text-white">
          ...
          <div className="text-center text-white p-8 mt-24  ">
            <h1 className="text-4xl font-bold">Depositary Participants</h1>
          </div>
        </div>
        </div>
      </div>
      ...
      <div className="bg-white min-h-screen">
        <div className="max-w-8xl mx-auto px-4 py-8 md:flex md:items-center md:space-x-8 md:-mt-60 md:mr-12">
          ...
          <div className="md:w-2/3">
            <div className="bg-white p-8 md:p-32 lg:mt-32">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                As a Depository Participant (DP), Sunlife Capital Limited serves
                as a crucial intermediary between the depository system (CDS and
                Clearing Ltd.) and our valued clients. Our DP services establish
                a vital link, facilitating seamless interaction between the
                company and its clients through the depository framework. Each
                of our individual clients enrolled in our DP services receives a
                dedicated account and is recognized as the beneficial owner of
                that account. This ensures efficient management and secure
                handling of securities transactions, enhancing transparency and
                trust in our services at Sunlife Capital.
              </p>
            </div>
          </div>
          ...
          <div className="md:w-1/3">
            <div className="bg-white p-8 md:p-12 lg:p-16 lg:mt-48">
      ...
      <div className=" py-12 lg:-mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-800 mt-8 mb-6">
            Depositary Participants Service Details
          </h2>
          <h3 className="text-xl font-bold text-gray-800 mb-4">
            Our DP services help individual clients to maintain their securities
            account balances and perform the following functions:
          </h3>
          <ul className="list-disc list-inside text-lg text-gray-700 mb-6">
            <li>
              Open Beneficiary Owner (BO) account and maintain separate accounts
              in the name of each BO
            </li>
            <li>
