    ...
    <div className="container mx-auto p-4">
      ...
      <div className="hidden md:block"> {/* Hide on mobile */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="md:col-span-6 grid grid-cols-3 gap-4 md:relative md:left-8 lg:left-96">
            <ProfileCard name="Rajiv Swarupchand" title="Chairman" imageSrc={person1} />
          </div>
          <div className="md:col-span-4 grid grid-cols-4 gap-4 md:relative md:right-40">
